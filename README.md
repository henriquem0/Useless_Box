...
* **[VarSpeedServo](https://www.usinainfo.com.br/blog/wp-content/uploads/2019/10/VarSpeedServo.zip)** (Necessário instalação manual via arquivo .ZIP na IDE do Arduino).
